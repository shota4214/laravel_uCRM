                    ...
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <input type="radio" id="gender1" name="gender" v-model="form.gender" value="0" class="ml-2">
                          <label for="gender1" class="ml-2">男性</label>
                          <input type="radio" id="gender2" name="gender" v-model="form.gender" value="1" class="ml-2">
                          <label for="gender2" class="ml-2">女性</label>
                          <input type="radio" id="gender" name="gender3" v-model="form.gender" value="2" class="ml-2">
                          <label for="gender3" class="ml-2">その他</label>
                        </div>
                      </div>
